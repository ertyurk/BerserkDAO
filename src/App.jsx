...
const tokenModule = sdk.getTokenModule(
  "0x9FB4a8426dB45DFa98E349E50c43C7a78569bC34"
);

const voteModule = sdk.getVoteModule(
  "0xd557f71c163fb5F6d78b82c0b060785bb7853606"
);
...
const App = () => {
      ...
      <div className="member-page">
                ...
                <div key={proposal.proposalId} className="card">
                  ...
                  <div>
                    {proposal.votes.map((vote) => (
                      <div className="btn_choose_sent" key={vote.type}>
                        <input
                          type="radio"
        ...
        <div className="footer-container">
          ...
          <a
            ...
            rel="noreferrer"
          >
            built on @_buildspace by @mehmetterturk
          </a>
        </div>
      </div>
    );
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free ⚔️ BerserkDAO Membership NFT</h1>
      <button
